...
class SuggestViewHolder(override val containerView: View?): RecyclerView.ViewHolder(containerView!!),
    LayoutContainer {
    ...
    fun bind(movie: MovieScreen, itemListener: SuggestAdapter.OnItemClickListener, position: Int, baseUrl: String) {
